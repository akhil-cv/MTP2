...
\includegraphics[width=6cm]{IIT logo.jpg}\\[0.5cm]
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{LOB snapshot.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{orderflow imbalance.png}
    \caption{orderflow}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{bid prob_regimes.png}
        \caption{Regime 0}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{bid prob_regime1.png}
        \caption{Regime 1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\linewidth}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{ask prob_regimes.png}
        \caption{Regime 0}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\linewidth}
        \centering
        \includegraphics[width=\linewidth]{ask prob_regime1.png}
        \caption{Regime 1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\linewidth}
